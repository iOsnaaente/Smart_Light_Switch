...
class _BulbPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (t > 0) {
      final halo = Paint()
        ..shader = RadialGradient(
          colors: [
            SmartLightColors.amberSoft.withValues(alpha: 0.55 * t),
            SmartLightColors.amber.withValues(alpha: 0),
          ],
    ...
    canvas.drawCircle(
      Offset(cx, cy),
      r,
      Paint()..color = SmartLightColors.amber.withValues(alpha: 0.16 * t),
    );
...
class _BarsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      canvas.drawRRect(
        rect,
        Paint()..color = SmartLightColors.amber.withValues(alpha: lit),
      );
    }
  }
